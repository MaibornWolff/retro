  ...
  return (
    <Box>
      ...
      <p>
        ...
        ein Sitebetreiber durch die Verwendung von verknüpfenden Links die Inhalte dieser gelinkten
        Seiten mit zu verantworten hat. Das kann, so das LG Hamburg, nur dadurch verhindert werden,
        dass man sich ausdrücklich von diesen Inhalten distanziert. Da wir keinen Einfluß auf
        Gestaltung und Inhalte der verlinkten Seiten haben, distanzieren wir uns hiermit
        ausdrücklich von diesen Seiten und Inhalten. Diese Erklärung gilt für alle auf unserer
        Homepage angebrachten Links und für alle Inhalte der Seiten, zu denen Links führen.
        <br />
        <br />
        ...
        <br />
        <br />
        Bilder von: Fernando Terry, Philippe Schrettenbrunner, Alexandra Mesmer, Maiborn Wolff GmbH,
        Adobe Stock, Kraftwerk
        <br />
        <br />
