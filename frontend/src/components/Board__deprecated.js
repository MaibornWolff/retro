...
/**
 * THIS IS THE OLD AND DEPRECATED CLASS COMPONENT
 * IT IS DEPRECATED SINCE WE HAVE A NEW VERSION UTILIZING HOOKS
 * THIS VERSION IS STILL HERE, IN CASE WE FIND BUGS IN THE HOOKS-VERSION
 * THIS VERSION WILL BE DELETED AFTER THE HOOKS-VERSION IS STABLE!
 */
class Board extends React.Component {
  state = { ...defaultBoard };

  socket = connectSocket(this.props.match.params.boardId);
